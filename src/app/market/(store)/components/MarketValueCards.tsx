...
const benefits = [
  ...
  },
  {
    ...
    text: "DataCredito no importa aqui. Con NOMI tu trabajo es tu garantia.",
    accent: "var(--nomi-navy)",
    bg: "var(--nomi-gray)",
  },
  {
    icon: Truck,
    title: "Descuento directo por nomina",
    text: "Tu empresa descuenta automaticamente cada mes. Tu solo compra y disfruta.",
    accent: "var(--nomi-orange)",
    bg: "var(--nomi-orange-bg)",
  },
];
...
const steps = [
  {
    ...
    text: "Explora miles de productos en tecnologia, hogar, moda, electrodomesticos y mas.",
  },
  {
    num: "2",
    color: "var(--nomi-teal)",
    title: "Selecciona tus cuotas",
    text: "Divide tu compra en cuotas comodas. Tu empresa descuenta directo de tu nomina cada mes.",
  },
  {
    num: "3",
    color: "var(--nomi-navy)",
    ...
    <div className="space-y-14">
      ...
      <section>
        <div className="mb-5">
          ...
          <h2 className="text-xl font-black" style={{ color: "var(--nomi-navy)" }}>
            Compra en{" "}
            <span style={{ color: "var(--nomi-orange)" }}>3 pasos</span>
          </h2>
        </div>
      ...
      <section>
        <div className="mb-5">
          ...
          <h2 className="text-xl font-black" style={{ color: "var(--nomi-navy)" }}>
            Cuanto pagarias{" "}
            <span style={{ color: "var(--nomi-orange)" }}>al mes?</span>
          </h2>
        </div>
